...
public class P6_Logic {

	public static void main(String[] args) {
		/* 결과값이 참 또는 거짓 => 조건식 => 비교연산자는 결과값이 참 또는 거짓 => 조건식
		 * 성적이 A학점인가? A학점의 기준은 90점이상 100점이하
		 * score가 90이상이고 score가 100점이하이다.
		...
		//유효한 성적인가?  잘못된 성적의 반대
		System.out.println(score3 + "점은 유효한 학점인가? " + !(score3 < 0 || score3 > 100));
